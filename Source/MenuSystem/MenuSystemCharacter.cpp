...
void AMenuSystemCharacter::OnCreateSessionComplete(FName SessionName, bool bWebSuccessful)
{
	if (bWebSuccessful)
	{
		if (GEngine)
...
void AMenuSystemCharacter::OnFindSessionComplete(bool bWSuccessful)
{
	if (!OnlineSessionInterface.IsValid())
	{
		return;
